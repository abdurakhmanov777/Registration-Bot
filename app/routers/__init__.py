...
from app.middlewares.middlewares import MwCallback, MwCommand
...
# from app.routers.group.callback import router as group_callback
from app.routers.user.command import router as user_command

# from app.routers.private.command import router as private_command
# from app.routers.private.message import router as private_message
